...
QCatGrayMonitorSerial* QCatGrayMonitorSerial::_instance = nullptr;
QMutex* QCatGrayMonitorSerial::m_pMutex = new QMutex;
bool QCatGrayMonitorSerial::m_bStart = false;
bool QCatGrayMonitorSerial::TheFirstTimeExamine = false;
int QCatGrayMonitorSerial::FrequencyTime = 500;

void QCatGrayMonitorSerial::run()
{
